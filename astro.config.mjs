...
const VOTE_CANDIDATES = [
  {
    ...
    stars: 124000,
    desc: "Web scraping & crawling for AI/LLM pipelines",
    votes: 0,
  },
  {
    repo: "iptv-org/iptv",
    stars: 116000,
    desc: "Collection of 8000+ publicly available IPTV channels",
    votes: 0,
  },
  {
  ...
  },
  {
    ...
    stars: 62000,
    desc: "Business intelligence and data visualisation platform",
    votes: 0,
  },
  {
    repo: "localstack/localstack",
    stars: 58000,
    desc: "AWS cloud emulator for local development",
    votes: 0,
  },
  {
    repo: "n8n-io/n8n",
    stars: 52000,
    desc: "Workflow automation with 400+ integrations",
    votes: 0,
  },
  {
    repo: "pocketbase/pocketbase",
    stars: 43000,
    desc: "Open-source backend in a single Go binary",
    votes: 0,
  },
  {
    repo: "novuhq/novu",
    stars: 34000,
    desc: "Open-source notification infrastructure",
    votes: 0,
  },
  {
    repo: "unclecode/crawl4ai",
    stars: 32000,
    desc: "Async web crawler built for AI data extraction",
    votes: 0,
  },
  {
    repo: "BerriAI/litellm",
    stars: 19000,
    desc: "Call 100+ LLM APIs using the OpenAI format",
    votes: 0,
  },
];
